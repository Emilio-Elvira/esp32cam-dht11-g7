 ...
 * de Adafruit y envía la temperatura y humedad relativa por MQTT en un JSON.
...
#define DHTPIN 13 // Pin para conectar el DHT11, pin GPI013 del ESP32CAM
#define DHTTYPE DHT11   // Configura el modelo de sensor,
...
const char* mqtt_server = "192.168.1.28"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
...
void setup() {
  ...
  dht.begin(); // Función que incia el sensor
...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    String json = "{\"id\":\"Emilio\",\"temp\":"+String(t)+",\"hum\":"+String(h)+"}";
